...
import { Container, CardView, CardDiv, ImageContainer, Image, Overlay } from "./styles";
...
const Home = () => {
  ...
  const CardItem = ({ data, index }) => {
    ...
    return (
      <CardDiv className={page === 1 && `animated fadeIn delay-${index > 10 ? 10 : index
        }00ms`} onClick={handleClick}>
        <ImageContainer>
